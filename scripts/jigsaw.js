...
// creates html DOM elements for each jigsaw piece and it's jigsaw piece template colour
function createDOMElements() {
    for(let i = 1; i < drawings.length + question + buffer; i++) {
        ...
        let col = 'blk';
        // create the element for the drawing
        ...
        // create element for the template
...
// positions jigsaw pieces in grid in relation to centre
...
// asks server for all user drawings
async function getDrawings() {
    ...
    const serverContact = await fetch('/get-all-user-drawings', options);
...
function switchPage(state, d) {
    ...
    if(state === 1) {
        ...
        // assign sources to DOM elements
            // this is chonky, but unfortunately necessary
